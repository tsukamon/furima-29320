...
ActiveRecord::Schema.define(version: 2020_09_06_145915) do
  ...
  create_table "destinations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_item_id"], name: "index_destinations_on_purchase_item_id"
  end
  ...
  add_foreign_key "destinations", "purchase_items"
